...
class FooterView extends LinearLayout {
    ...
    private void init(Controller.Params params) {
        ...
        if (footerNegative != null) {
            ...
            mNegativeButton.setTextSize(TypedValue.COMPLEX_UNIT_PX,footerNegative.getTextSize());
        ...
        if (mFooterPositive != null) {
            ...
            mPositiveButton.setTextSize(TypedValue.COMPLEX_UNIT_PX,mFooterPositive.getTextSize());
