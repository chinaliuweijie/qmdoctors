    ...
    public void setState(State status, boolean showView) {
        ...
        switch (status) {
         ...
         //       mLoadingText.setTextColor(ContextCompat.getColor(getContext(), hintColor));
                mLoadingText.setTextColor(getResources().getColor(R.color.text));
                break;
            case NoMore:
                setOnClickListener(null);
                if (mLoadingView != null) {
              ...
              //  mNoMoreText.setTextColor(ContextCompat.getColor(getContext(), hintColor));
                mNoMoreText.setTextColor(getResources().getColor(R.color.text));
                break;
            case NetWorkError:
              ...
              //  mNoNetWorkText.setTextColor(ContextCompat.getColor(getContext(), hintColor));
                mNoNetWorkText.setTextColor(getResources().getColor(R.color.text));
                break;
            default:
                break;
        }
