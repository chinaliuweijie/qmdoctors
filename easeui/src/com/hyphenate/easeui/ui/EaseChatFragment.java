...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = {R.drawable.photo, R.drawable.file};
    ...
    protected void initView() {
        ...
        if(mapData!=null){
            messageList.setMapData(mapData);
        }
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.btn_green_noraml);
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_TAKE_PICTURE:
                    onOpenPhotoListener.onOpenPhoto();
                    break;
                case ITEM_PICTURE:
                    //选择文件
                //    selectPicFromLocal();
                    onOpenPhotoListener.onOpenFile();
                    break;
    ...
    private OnOpenPhotoListener onOpenPhotoListener;
    ...
    public void setonOpenPhotoListener(OnOpenPhotoListener onOpenPhotoListener) {
        this.onOpenPhotoListener = onOpenPhotoListener;
    }
    ...
    protected void sendMessage(EMMessage message) {
        ...
        // 添加消息的扩展 给对方
        if(attribute!=null){
            String avatar = attribute.getString("avatar");
            message.setAttribute("avatar",avatar);
            String nickname = attribute.getString("nickname");
            message.setAttribute("nickname",nickname);
            String uid = attribute.getString("uid");
    ...
    private Bundle attribute;

    public void setMessageAttribute(Bundle attribute){
