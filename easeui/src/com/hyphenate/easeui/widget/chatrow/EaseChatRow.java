...
//            if(mapData!=null){
//                String nickname = mapData.get("dNickname");
//                String avatar = mapData.get("dAvatar");
//                if(!avatar.contains("http")){
//                    avatar = GlideUtils.SERVER_URL + avatar;
//                }
//                GlideUtils.LoadCircleImage(context,avatar,userAvatarView);
//            }else{
...
//                String avatar = mapData.get("uAvatar");
//                String nickname = mapData.get("uNickname");
//                if(!avatar.contains("http")){
//                    avatar = GlideUtils.SERVER_URL + avatar;
//                }
//                GlideUtils.LoadCircleImage(context,avatar,userAvatarView);
