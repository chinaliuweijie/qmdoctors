...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    private IconFontTextview faceNormal;
    private IconFontTextview faceChecked;
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        faceNormal = (IconFontTextview) findViewById(R.id.iv_face_normal);
        faceChecked = (IconFontTextview) findViewById(R.id.iv_face_checked);
